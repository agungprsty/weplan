...
class BridesmaidItem(Base):
    __tablename__ = "bridesmaid_items"
    ...
    wedding: Mapped[Wedding] = relationship(back_populates="bridesmaid_items")  # noqa: F821
    guest: Mapped[Guest] = relationship(back_populates="bridesmaid_detail")  # noqa: F821
